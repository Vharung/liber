                ...
                content: \`
                  <p>Sélectionnez une option :</p>
                    ...
                    if(item.system.cout){//a tester
                      let unmodifiable=null;
                      if(item.system.degats !='X'){
                        unmodifiable='readonly';
                      }
                      command+=`<p>Psy dépensés :</p>
                      <div class="form-group">
                          <input type="text" id="userpsy" name="userpsy" value="${item.system.cout}" style="text-align:center" ${unmodifiable}/>
                      </div>`;
                    };
                    command+=`<p>Entrez le bonus/malus :</p>
                    <div class="form-group">
        ...
        showInputDialogWithSelect(options, (userInput, selectedOption,userposture,userpsy) => {
          if(selectedOption!=="Aucun"){
            ...
            r.evaluate().then((result) => {
              ...
              if (item.system.cout) {//a tester : récuperer le cout du sort, mettre à jour psy, pv insoinable, si le cout est X demander combien de mana on mets
                command+=`
