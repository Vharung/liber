...
export class LiberActorSheet extends ActorSheet {
    ...
    getData(){
        ...
        if (this.actor.type == 'personnage' || this.actor.type == 'pnj') {
            this._prepareCharacterItems(data);this._onStat();
        }
        return data;
    }
    ...
    activateListeners(html){
       ...
       //Colorisation des compétences
        ...
        //Mettre metier par défaut ou faiblesse
...
options.each(function() {
    ...
    _onGenerator(event){
        ...
        if(race==game.i18n.localize("liber.avantrace60")){
            ...
            avantagerace=game.i18n.localize("liber.avantrace2");cpt28=5;cpt50=5;
        }else if(race==game.i18n.localize("liber.avantrace62")){
    ...
    async _onStat(event){
        ...
        if(race==game.i18n.localize('liber.avantrace77a')){
            ...
            metier=game.i18n.localize('liber.avantrace93');//actor.system.metier
        }else if(reli==game.i18n.localize('liber.avantrace58')){ 
            metier=game.i18n.localize('liber.avantrace94');
        } 
        //encombrement
        if(forc==''){forc=0}
        if(puis==''){puis=0}
