...
export class LiberActorSheet extends ActorSheet {
    ...
    async _onGenerator(event){
       //variable
        ...
        const armes=['Bâton', 'Espadon', 'Hallebarde', 'Fléaux d\'arme', 'Epée à deux main', 'Masse d\'arme', 'Hache de bataille', 'Faux de Guerre', 'Lance Lourde']
        ...
        let culte = clans.find(clan => culte.name === relig);
        if (culte) {
